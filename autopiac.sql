...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Feb 11. 10:04
...
INSERT INTO `jarmuvek` (`id`, `marka`, `tipus`, `evjarat`, `kilometer`, `szin`, `motor_tipus`, `motor_meret`, `teljesitmeny`, `sebessegvalto`, `ar`, `allapot`, `felszereltseg`, `muszaki_vizsga`, `elojel`) VALUES
(1, 'Toyota', 'Corolla', 2015, 120000, 'Fehér', 'Benzin', '1.60', 132, 'Automatikus', '3500000.00', 'Jó állapot', 'Klíma, Navigáció', '2025-12-01', 'Eladó'),
(2, 'BMW', 'M5 Competition', 2022, 165000, 'Fekete', 'Benzin', '3.00', 530, 'Automatikus', '29000000.00', 'Megkímélt', 'Digitális Klíma, Lemeztető, Összkerék', '2025-02-01', 'Eladó Garanciális');
...
--
-- Tábla szerkezet ehhez a táblához `keresesi_informaciok`
--

CREATE TABLE `keresesi_informaciok` (
  `id` int(11) NOT NULL,
  `jarmu_id` int(11) DEFAULT NULL,
  `keresett_feltetel` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `torteneti_adatok` (
  `id` int(11) NOT NULL,
  `jarmu_id` int(11) DEFAULT NULL,
  `elozo_tulajdonosok` int(11) DEFAULT NULL,
  `baleset` tinyint(1) DEFAULT NULL,
  `szerviztortenet` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- A tábla indexei `keresesi_informaciok`
--
ALTER TABLE `keresesi_informaciok`
  ADD PRIMARY KEY (`id`),
  ADD KEY `jarmu_id` (`jarmu_id`);
...
--
-- AUTO_INCREMENT a táblához `keresesi_informaciok`
--
ALTER TABLE `keresesi_informaciok`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `kapcsolatok`
  ADD CONSTRAINT `kapcsolatok_ibfk_1` FOREIGN KEY (`jarmu_id`) REFERENCES `jarmuvek` (`id`);
...
--
-- Megkötések a táblához `keresesi_informaciok`
--
ALTER TABLE `keresesi_informaciok`
  ADD CONSTRAINT `keresesi_informaciok_ibfk_1` FOREIGN KEY (`jarmu_id`) REFERENCES `jarmuvek` (`id`);
